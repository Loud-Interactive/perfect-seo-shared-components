        ...
        <div className="col-12 col-lg-6">
          <div className="row g-3">
            <div className="col-12">
              ...
              <p className="m-0">  <strong className="text-primary me-1">Title</strong>  {localPost?.title}{(localPost?.writing_language !== 'English' && localPost?.writing_language) && <small>({localPost?.writing_language})</small>}{(localPost.client_domain !== domain_name) ? <span className='badge bg-primary ms-2'>{localPost?.client_name}</span> : email !== localPost.email ? <p>generated by <span className="text-primary">{localPost.email}</span></p> : null}
              </p>
            </div>

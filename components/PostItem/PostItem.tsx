          ...
          <div className="row g-2">
            <div className="col-12">
              ...
              <p className="m-0">
                ...
                <small>
                  {(localPost.client_domain !== domain_name) ? <span className='badge bg-primary ms-2'>{localPost?.client_name}</span> : email !== localPost.email ? <span className="ms-2 text-primary"><strong>generated by </strong><span className="text-dark">{localPost.email}</span></span> : null}
                </small>
              </p>
